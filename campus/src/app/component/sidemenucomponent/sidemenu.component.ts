...
@Component({
  ...
  imports: [IonicModule, RouterLink, NgForOf, RouterLinkActive, CommonModule],
...
export class SidemenuComponent implements OnInit {
  ...
  errorMessage: string = '';
  // 인증 검증
  userRole: string | null = null; // 사용자 역할
  ...
  async navigateTo(page: string) {
    ...
    try {
      ...
      await this.showToast(
        error instanceof Error ? error.message : '페이지 이동 중 오류가 발생했습니다.',
      );
      await this.router.navigate(['/classnone']);
    }
  }
